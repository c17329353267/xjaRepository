			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn">
							<a class="btn-append " id="InitCartUrl" href="javascript:addCarItem()" clstag="shangpin|keycount|product|initcarturl">加入购物车<b></b></a>
					</div>
...
<script type="text/javascript">
	...
	function addCarItem(){
		var num = $("#buy-num").val();		
		location.href="http://localhost:8091/car/add/${item.id}.html?num="+num;
	}
</script>
</body>
</html>